...
enum class ShipClass(
    ...
    LIVESHIP(                "Liveship",               2500, 100, 1800,  55, 4800, 5, hanger = 50),
    CITYSHIP(                "Cityship",               5000, 250, 3600,  40, 7200, 6, hanger = 100),
    ...
    CARRIER(                 "Carrier",                 250, 125, 1100, 100,  240, 2, 1, 1, 0, 50),
    BATTLESHIP(              "Battleship",              500, 250, 1600,  90,  280, 3, 4, 2, 1, 20),
    DREADNOUGHT(             "Dreadnought",             800, 400, 2400,  80,  400, 4, 5, 3, 1, 30),
    FLEET_CARRIER(           "Fleet Carrier",           750, 400, 1800,  75,  480, 4, 2, 2, 0, 120),
    TITAN(                   "Titan",                  1100, 600, 3600,  60,  600, 5, 5, 4, 2, 50),
    BATTLECARRIER(           "BattleCarrier",          1500, 800, 4800,  60,  640, 5, 4, 3, 2, 100),
