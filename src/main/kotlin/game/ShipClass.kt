...
enum class ShipClass(
        ...
        val fuelGatherMultiplier: Double = 1.0, val oreMultiplier: Double = 1.0, val foodGatherMutliplier: Double = 1.0
) {
    // civilian
    SMALL_PASSENGER_CARRIER( "Small Passenger Carrier",  50,   2,  200,  90,   80, 1, foodGatherMutliplier = 2.0),
    MEDIUM_PASSENGER_CARRIER("Medium Passenger Carrier", 90,   3,  300,  85,  160, 1, foodGatherMutliplier = 2.0),
    LARGE_PASSENGER_CARRIER( "Large Passenger Carrier", 150,   5,  360,  80,  240, 2, foodGatherMutliplier = 2.0),
    HUGE_PASSENGER_CARRIER(  "Huge Passenger Carrier",  250,   8,  400,  75,  320, 3, foodGatherMutliplier = 2.0),
    ...
    // frieght
    SMALL_FREIGHT_CARRIER(   "Small Freight Carrier",    25,   3,  240,  90,  160, 1, fuelGatherMultiplier = 2.0),
    MEDIUM_FREIGHT_CARRIER(  "Medium Freight Carrier",   45,   6,  300,  80,  320, 1, fuelGatherMultiplier = 2.0),
    LARGE_FREIGHT_CARRIER(   "Large Freight Carrier",    80,  10,  360,  70,  560, 2, fuelGatherMultiplier = 2.0),
    HUGE_FREIGHT_CARRIER(    "Huge Freight Carrier",    120,  20,  440,  60,  800, 2, fuelGatherMultiplier = 2.0),
    SUPER_FREIGHT_CARRIER(   "Super Freight Carrier",   150,  35,  500,  55, 1120, 3, fuelGatherMultiplier = 2.0),
    REFINERY_SHIP(           "Refinery Ship",           100,  40,  460,  80,  480, 2),
    FUEL_TANKER(             "Fuel Tanker",              60,  10,  400,  70, 1280, 2, fuelGatherMultiplier = 3.0),
    MOBILE_DRY_DOCK(         "Mobile Dry-Dock",         160,  80,  500,  65,  400, 2, hanger = 10),
    MINING_SHIP(             "Mining Ship",              60,  30,  400,  75,  720, 2, oreMultiplier = 3.0),
    // military
